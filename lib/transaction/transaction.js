...
if (Network.defaultNetwork.name === 'livenet' || Network.defaultNetwork.name === 'testnet') {
...
} else if (Network.defaultNetwork.name === 'reddcoin-livenet') {
	var CURRENT_VERSION = 1;
	var DEFAULT_NLOCKTIME = 0;
	...
	// max amount of satoshis in circulation
	Transaction.MAX_MONEY = 92233720368 * 1e8;
